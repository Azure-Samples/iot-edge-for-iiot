...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = '#SQLEDGE_ADMIN_PASSWORD#';
CREATE DATABASE SCOPED CREDENTIAL dashboardsSQLCredential WITH IDENTITY = 'sa', SECRET = '#SQLEDGE_ADMIN_PASSWORD#'
