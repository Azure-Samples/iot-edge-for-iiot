...
echo ""
echo "edgeAgent..."
az acr import --name $acrName --force --source mcr.microsoft.com/azureiotedge-agent:1.2 --image azureiotedge-agent:1.2
echo "edgeHub..."
az acr import --name $acrName --force --source mcr.microsoft.com/azureiotedge-hub:1.2 --image azureiotedge-hub:1.2
echo "diagnostics..."
az acr import --name $acrName --force --source mcr.microsoft.com/azureiotedge-diagnostics:1.2 --image azureiotedge-diagnostics:1.2
echo "API proxy..."
