...
In a third part, we'll monitor the security of IoT Edge devices from the Cloud with Defender for IoT.
...
3. [Secure your IoT Edge devices with Defender for IoT](3-SecureYourDevices.md) (15 mins)
